...
import os
import sys
import collisionDetectorTest as CDT
...
def performDetect(imagePath="images/montacargas1.jpg", thresh= 0.25, configPath = "./cfg/yolo-obj.cfg", weightPath = "yolo-obj-final.weights", metaPath= "./cfg/obj.data", showImage= True, makeImageOnly = False, initOnly= False):
    """
    ...
    test = CDT.Test()
    return test.run(detections["detections"])
...
if __name__ == "__main__":
	print(performDetect(imagePath=sys.argv[1],thresh=float(sys.argv[2])))
